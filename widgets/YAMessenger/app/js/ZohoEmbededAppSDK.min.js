...
f+=(-1<f.indexOf("?")?"\x26":"?")+x}f={url:f,Header:g,Body:m,CONTENT_TYPE:w,RESPONSE_TYPE:D,PARTS:h,PARTS_BOUNDARY:l,FILE:d}}return b({category:"CONNECTOR",nameSpace:a,data:f,type:e})}function g(a){$.extend(a,{category:"UI"});return b(a)}function r(a,d,e){return b({category:"CONFIG",type:a,nameSpace:d,APIData:e})}function u(a){var d={category:"USER"};a.ID?d.ID=a.ID:a.Type&&(d.Type=a.Type,a.page&&(d.page=a.page),a.per_page&&(d.per_page=a.per_page));return b(d)}function k(a){return b({category:"META",
